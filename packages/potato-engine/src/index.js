...
export { default as Thinker } from './entities/thinker';
export { default as Magnet } from './entities/magnet';
export { default as Player } from './entities/player';

export { _directions as directions };

export { entityTypeRegistry as entities } from './entities';
export { entityTypeRegistry } from './entities';
